...
def test6():
    ...
    wrong = []
    for annotations1, annotations2 in pair_annotations:
        bad_case =  [319, 332, 336, 345, 354]
        if annotations1[0]['pair_id'] not in bad_case:
            continue

        #print len(annotations1)
        #print len(annotations2)
        #print len([o for o in annotations1 if o['object_id'] in object_id_pair])
        #print len([o for o in annotations2 if o['object_id'] in object_id_pair])
