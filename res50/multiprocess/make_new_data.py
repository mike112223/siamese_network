...
f = open('/data-4t/home/yanjia/siamese_shelf/length_data/json_data/pair_train_data.json', 'w')
f.write(JsonTrainPairData)
f.close()

f_test = open('./test/length_image_list_test_scale_9_10_11.txt', 'wb')
f_test_p = open('./test/length_image_list_test_scale_9_10_11_p.txt', 'wb')
