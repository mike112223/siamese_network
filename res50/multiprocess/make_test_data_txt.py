...
cur.execute('''select o.id, o.x_pixel, o.y_pixel, o.width_pixel, o.height_pixel, i.url, i.id, o.type, i.src_src from object o inner join image i on o.img_id = i.id where i.verify_status = 1 and o.box_status = 0 \
    and i.id in (select distinct img_id from object where id in (select object_id from object_sames_11 where status = 1) \
...
f_test = open('./test/length_image_list_11_test_scale.txt', 'wb')
f_test_p = open('./test/length_image_list_11_test_p_scale.txt', 'wb')
